      ...
      <Wrap>
        ...
        <MessageWrap>
          ...
          >
            ...
            <WallMessageId>
              <span style={{ color: "#ee1183", fontWeight: "700" }}>
                {wallMessages[curMsgIdx].id}
              </span>
              의 글
            </WallMessageId>
          </div>
              ...
              .map((v, i) => (
                <ShowDataCom key={i}>
                  <div>
                    ...
                    <WallTime>
                      {v.creationTime &&
                        formatTime(v.creationTime.seconds * 1000)}
                    </WallTime>
                    <br />
